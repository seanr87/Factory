...
detection:
  ...
  # In progress once enough institutions are being tracked for the study to be
  # a network study. Ready for review once that many have said they are
  # interested — "enough partners to be worth running" is a judgement, so a
  # human still closes it.
...
**What this gate means.** You've identified the institutions you're asking to run your study, each one has an issue in this repository, and you've made contact. The gate closes when you have enough interested partners for the study to be worth running.
...
- You know which partners are interested versus merely contacted, and the issues distinguish the two.

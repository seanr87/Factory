...
def _self_test():
    ...
    cases = [
        ...
        ("an empty board is filled from the label",
         decide("status:committed", t0, None, None) == ("board", "Committed")),
        ...
        ("a later board change wins",
         decide("status:contacted", t0, "Committed", t1) == ("label", "status:committed")),
        ("a later label change wins",
         decide("status:committed", t1, "Contacted", t0) == ("board", "Committed")),
